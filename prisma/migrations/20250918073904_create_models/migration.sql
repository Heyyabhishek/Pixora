-- CreateEnum
CREATE TYPE "public"."UserRole" AS ENUM ('UNASSIGNED', 'CLIENT', 'CREATOR', 'ADMIN');
...
-- CreateIndex
CREATE INDEX "Availability_creatorId_startTime_idx" ON "public"."Availability"("creatorId", "startTime");

-- CreateIndex
CREATE INDEX "Appointment_status_startTime_idx" ON "public"."Appointment"("status", "startTime");

-- CreateIndex
CREATE INDEX "Appointment_creatorId_startTime_idx" ON "public"."Appointment"("creatorId", "startTime");
...
-- AddForeignKey
ALTER TABLE "public"."Availability" ADD CONSTRAINT "Availability_creatorId_fkey" FOREIGN KEY ("creatorId") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."Payout" ADD CONSTRAINT "Payout_creatorId_fkey" FOREIGN KEY ("creatorId") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
