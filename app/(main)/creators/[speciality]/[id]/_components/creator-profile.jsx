// /app/creators/[id]/_components/creator-profile.jsx
"use client";
...
export function CreatorProfile({ creator, availableDays }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      {/* Left column - Creator Photo and Quick Info (fixed on scroll) */}
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <div className="flex items-center justify-center mb-2">
                  ...
                  <span className="text-muted-foreground">
                    {creator.experience} years experience
                  </span>
                </div>
      ...
      {/* Right column - Creator Details and Booking Section */}
              ...
              <CardContent className="space-y-6">
                {totalSlots > 0 ? (
                  ...
                  <div className="text-center py-6">
                    ...
                    <p className="text-muted-foreground">
                      This creator doesn&apos;t have any available appointment
