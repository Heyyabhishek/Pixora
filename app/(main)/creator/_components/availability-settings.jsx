...
import { setAvailabilitySlots } from "@/actions/creator";
import useFetch from "@/hooks/use-fetch";
import { toast } from "sonner";



export default function AvailabilitySettings({ slots }) {
      ...
      <CardContent>
        ...
        <div className="mt-6 p-4 bg-muted/10 border border-emerald-900/10 rounded-md">
          ...
          <p className="text-muted-foreground text-sm">
            Setting your daily availability allows clients to book your services during those hours. The same availability applies to all days. You can update your availability at any time,
            but existing booked appointments or sessions will not be affected.
          </p>
        </div>
      </CardContent>
    </Card>
