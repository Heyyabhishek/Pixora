                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <h3 className="font-medium text-white">
                            Dr. {payout.creator.name}
                          </h3>
                          <p className="text-sm text-muted-foreground">
                            {payout.creator.speciality}
                          </p>
            ...
            <div className="space-y-6 py-4">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-white font-medium">Creator Information</h3>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-white">
                      Dr. {selectedPayout.creator.name}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-muted-foreground">
                  ...
                  <div>
                    ...
                    <p className="text-white">
                      {selectedPayout.creator.speciality}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-muted-foreground">
              ...
              {selectedPayout.creator.credits < selectedPayout.credits && (
                <Alert variant="destructive">
                  ...
                  <AlertDescription>
                    Warning: Creator currently has only{" "}
